...
def add_cfg_if_missing(cfg, name, default):
    """
    Add a configuration parameter if it is missing.
    ...
    Returns:
        cfg: The updated configuration dictionary.
    """
...
class EmotionMLP(torch.nn.Module):
    """
    EmotionMLP module for emotion recognition.

    Args:
        config: The configuration.
        deca_cfg: DECA configuration.
    """
    ...
    def forward(self, values, result_prefix=""):
        ...
        Args:
            values: Input values.
            result_prefix: Prefix for the result.
    ...
    def compute_loss(self, pred, batch, training, pred_prefix=""):
        ...
        Args:
            ...
            pred_prefix: Prefix for predictions.
