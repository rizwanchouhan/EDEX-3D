...
# Function to read an image robustly, trying different extensions if necessary
...
# Function to concatenate a batch of images into a tall image
def concatenate_image_batch_to_tall_image(images: torch.Tensor) -> torch.Tensor:
    return images.reshape([-1,] + list(images.shape[2:]))

# Function to concatenate a batch of images into a wide image
...
# Function to convert a torch Float image to a numpy uint8 image
...
# Function to convert a numpy image to a torch tensor
