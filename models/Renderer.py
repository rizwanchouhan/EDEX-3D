...
class SRenderY(nn.Module):
    def __init__(self, image_size, obj_filename, uv_size=256):
        ...
        verts, faces, aux = load_obj('/home/abbas/dream/assets/FLAME/geometry/head_template.obj')
    ...
    def forward(self, vertices, transformed_vertices, albedos, lights=None, light_type='point'):
        ...
        transformed_vertices: [batch_size, V, 3], range:[-1,1], projected vertices, in image space, for rasterization
