...
# Function to calculate signed agreement ratio
...
# Function to calculate mean accuracy using PyTorch
...
# Function to calculate concordance correlation coefficient using PyTorch
...
# Function to calculate weighted average and standard deviation using PyTorch
...
# Function to calculate ICC(3, 1) using PyTorch
